...
(
  ...
  CONTRAINT `FK_User` FOREIGN KEY (UserObjectGUID) REFERENCES WRADUser(ObjectGUID) ON DELETE CASCADE,
  CONTRAINT `FK_Group` FOREIGN KEY (GroupObjectGUID) REFERENCES WRADGroup(ObjectGUID)  ON DELETE CASCADE
);
...
(
  ...
  CONTRAINT `FK_ChildGroup` FOREIGN KEY (ChildGroup) REFERENCES WRADGroup(ObjectGUID) ON DELETE CASCADE,
  CONTRAINT `FK_ParentGroup` FOREIGN KEY (ParentGroup) REFERENCES WRADGroup(ObjectGUID) ON DELETE CASCADE
);
...
(
  ...
  ObjectGUID VARCHAR(36) NOT NULL,
  PRIMARY KEY (SettingID),
  CONTRAINT `FK_User` FOREIGN KEY (ObjectGUID) REFERENCES WRADUser(ObjectGUID) ON DELETE CASCADE
);
...
(
  ...
  ObjectGUID VARCHAR(36) NOT NULL,
  PRIMARY KEY (SettingID),
  CONTRAINT `FK_Group` FOREIGN KEY (ObjectGUID) REFERENCES WRADGroup(ObjectGUID) ON DELETE CASCADE	
);
