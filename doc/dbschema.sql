...
(
  ...
  CONSTRAINT `FK_User` FOREIGN KEY (UserObjectGUID) REFERENCES WRADUser(ObjectGUID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Group` FOREIGN KEY (GroupObjectGUID) REFERENCES WRADGroup(ObjectGUID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
  ...
  CONSTRAINT `FK_ChildGroup` FOREIGN KEY (ChildGroupObjectGUID) REFERENCES WRADGroup(ObjectGUID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_ParentGroup` FOREIGN KEY (ParentGroupObjectGUID) REFERENCES WRADGroup(ObjectGUID) ON DELETE CASCADE ON UPDATE CASCADE
);
