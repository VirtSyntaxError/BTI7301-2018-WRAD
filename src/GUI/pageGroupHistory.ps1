        ...
        New-UDColumn -Size 6 -Content {
            ...
            New-UDGrid -Title "All user" -Header @("Groupname", "Group Type", "Create date", "History") -Properties @("Groupname", "GroupType", "CreatedDate", "History") -Endpoint {
                ...
                ForEach($Group in $AllGroup){
                    $AllGroupGrid += @{Groupname = $Group.CommonName; GroupType = $Group.GroupType; History =(New-UDLink -Text "History" -Url "/GroupHistory/$($Group.ObjectGUID)")} 
                }
...
>>>>>>> 09b9f8c6de655a64a38d8fc675152a1d8f7a8e11
}